    ...
    <section className="w-full h-[calc(100vh-80px)] flex flex-col justify-center items-center">
      <article className="w-[60%] bg-gray-900 rounded-t-md px-4">
        <header className="w-full">
          <h1 className="text-3xl font-bold uppercase text-white py-8 px-4">
            Deleting Account
          </h1>
        </header>
        <div className="py-2 px-4 text-white text-lg">
          <p>
      ...
      <main className="w-[60%] text-white bg-gray-900 px-4">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6 px-4 py-2 text-lg flex justify-between items-center">
            <input
              ...
              name="confirmText"
              id="confirmText"
              className="px-2 py-2 bg-gray-500 outline-none rounded-md font-semibold focus:ring-2 focus:ring-red-600 text-red-600"
              value={confirmText}
